  ...
  offerings: [
    {
      ...
      capacityPax: 15,
      // RM 550 a night for the whole house — one real quote the owner gave a
      // guest, not a published rate. Read as the weekday rate because the stay
      // it was quoted for (28th–29th) falls on a Monday–Tuesday with no public
      // holiday and outside every school break. If that enquiry was in fact for
      // August, the same dates are a Friday–Saturday at the head of the Term 2
      // school break and two days before Merdeka — peak — and this number is a
      // ceiling rather than a floor.
      // TODO(owner): confirm which, because the two readings are 40% apart.
