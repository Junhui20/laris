...
export const pangkorMyHomestay: BusinessContext = {
  ...
  offerings: [
    {
      ...
      rateCalendar: [],
      minNights: 1,
      // Her times move with the date, the same way her rate does: on a 大日子
      // the house turns around back to back, so it is 14:00 in and 12:00 out;
      // on a quiet night you can come early and leave as late as 15:00. The
      // schema holds one pair, so it holds the guaranteed one — a guest is
      // never worse off than the page says. The flexibility is in the FAQ.
      checkin: "14:00",
      checkout: "12:00",
  ...
  faq: [
    ...
    {
      q: "几点可以入住？几点要退房？",
      a: "大日子（公共假期、学校假期、周末）下午 2 点进、中午 12 点退，因为屋子当天要接下一组客人。平时人不多的话可以早点进来，最迟下午 3 点退房 —— 订房的时候问一声就好。",
      source: "merchant",
    },
    {
      q: "要给订金吗？",
